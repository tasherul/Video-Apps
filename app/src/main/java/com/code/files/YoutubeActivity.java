...
public class YoutubeActivity extends YouTubeBaseActivity {
    final static String TAG = YoutubeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_youtube_player.initialize(AppConfig.YOUTUBE_API_KEY, onInitializedListinner);
    }
